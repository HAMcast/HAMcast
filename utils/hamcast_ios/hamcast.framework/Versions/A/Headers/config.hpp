 ...
 * @ingroup Config
 */
const boost::uint32_t minor_version HC_STATIC_CONSTANT = 5;
 ...
 * @ingroup Config
 */
const boost::uint32_t min_compatile_minor_version HC_STATIC_CONSTANT = 5;

/**
 * @brief The default maximum buffer size (16MB).
 * @ingroup Config
 */
const size_t default_max_buffer_size HC_STATIC_CONSTANT = 16 * 1024 * 1024;
...
/**
 * @brief The time interval of forced acknowledgements in microseconds.
 *
 * Default is 5ms.
 * @ingroup Config
 */
const size_t force_ack_us_interval HC_STATIC_CONSTANT = 5000;
