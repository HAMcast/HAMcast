...
void hex_to_base2 (char *hexstr, char *binstr, size_t b2slen)
{
    int i = 0;
    memset (binstr, 0, b2slen);
...
void hex_to_base4 (char *hexstr, char *base4str, size_t b4slen)
{
    int i = 0;
    memset (base4str, 0, b4slen);
    for (i = 0; i < strlen (hexstr); i++)
	{
	    switch (hexstr[i])
		{
...
void base2_to_hex (char *binstr, char *hexstr, size_t hslen)
{
    int i = 0;
    int j = 0;
    memset (hexstr, 0, hslen);
