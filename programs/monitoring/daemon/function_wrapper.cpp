...
function_wrapper::function_wrapper(std::string name)
    : method_caller(name)
{
    register_function("/get_node", (function_call)&function_wrapper::get_node);
    register_function("/children_set", (function_call)&function_wrapper::get_children_set);
    register_function("/parent_set", (function_call)&function_wrapper::get_parent_set);
    register_function("/neighbor_set", (function_call)&function_wrapper::get_neighbor_set);
    register_function("/group_set", (function_call)&function_wrapper::get_group_set);
    register_function("/interface", (function_call)&function_wrapper::get_interfaces);
    register_function("/is_img", (function_call)&function_wrapper::get_is_img);


}


std::vector<hamcast::uri> function_wrapper::children_set(int& id, hamcast::uri& g){
...
std::vector<hamcast::uri> function_wrapper::parent_set(int& id, hamcast::uri& g){
    std::vector<hamcast::uri> ret;
    try{
...
std::vector<hamcast::uri> function_wrapper::neighbor_set(int& id){
    std::vector<hamcast::uri> ret;
    try{
...
std::vector<std::pair<hamcast::uri,unsigned int> > function_wrapper::group_set(int& id){
...
std::vector<hamcast::interface_property> function_wrapper::interfaces(){
...
std::string function_wrapper::get_node(const std::vector<std::string>& args)
{
...
std::string function_wrapper::get_children_set(std::vector<std::string>& args){
    if(args.size() < 2){
...
std::string function_wrapper::get_parent_set(std::vector<std::string>& args){
    if(args.size() < 2){
        std::string errcode = "404";
        std::string payload;
        http_message errmsg(errcode,payload);
...
std::string function_wrapper::get_neighbor_set(std::vector<std::string>& args){
    if(args.size() < 1){
        std::string errcode = "404";
        std::string payload;
        http_message errmsg(errcode,payload);
...
std::string function_wrapper::get_group_set(std::vector<std::string>& args){
    if(args.size() < 1){
        std::string errcode = "404";
        std::string payload;
        http_message errmsg(errcode,payload);
...
std::string function_wrapper::get_interfaces(std::vector<std::string>& args){
    if(args.size() !=0){
        std::string errcode = "404";
        std::string payload;
        http_message errmsg(errcode,payload);
...
std::string function_wrapper::get_is_img(std::vector<std::string>& args){
    if(args.size() !=0){
        std::string errcode = "404";
        std::string payload;
        http_message errmsg(errcode,payload);
