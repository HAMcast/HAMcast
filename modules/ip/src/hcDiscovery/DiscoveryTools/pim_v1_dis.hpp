...
#ifndef PIMV1_DISCOVERY_H
#define PIMV1_DISCOVERY_H

#include "hcDiscovery/DiscoveryTools/basic_dis.hpp"


///@author Sebastian Woelke
///@brief discover PIMv1 on a spezific network interface

#define LOGMSG 1
#define PIMv1_PACKET_LEN 100
#define PIMv1_FILTER_EXP "igmp" //Pcap Filter expression
//tcpdump bug at version 1.0.0 "ip6 protochain ipv6-icmp"
//ip6  proto  should  chase header chain, but at this moment it does not.
//ip6 protochain is supplied for this behavior.

#define PIMv1_PASSIV_TIMEOUT 255 //sec ( 2*125sec + 5


class pim_v1_dis : public basic_dis
{
private:
     string m_pcapFilter;
protected:
