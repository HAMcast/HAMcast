...
RELEASE_CMD="$CORE_RELEASE ; $JAVA_RELEASE"
...
verbose_exec "cp $CLONE_PATH/run_hcstatus.sh $RELEASE_PATH/."
...
verbose_exec "cp -r $CLONE_PATH/modules/bidirsam $RELEASE_PATH/modules/."
...
verbose_exec "mkdir $RELEASE_PATH/testing"
verbose_exec "cp -r $CLONE_PATH/testing/test_send_performance $RELEASE_PATH/testing/."
verbose_exec "cp -r $CLONE_PATH/testing/test_receive_performance $RELEASE_PATH/testing/."
verbose_exec "cp -r $CLONE_PATH/testing/benchmark $RELEASE_PATH/testing/."
verbose_exec "rm -rf $RELEASE_PATH/testing/benchmark/script"
verbose_exec "rm -rf $RELEASE_PATH/testing/benchmark/openwrt-scripts"
verbose_exec "rm $RELEASE_PATH/testing/benchmark/multigroup.sh"
verbose_exec "rm $RELEASE_PATH/testing/benchmark/multisock_benchmark.sh"
verbose_exec "rm $RELEASE_PATH/testing/benchmark/singlsock_benchmark.sh"
...
verbose_exec "cd $BASEDIR"
verbose_exec "mkdir $RELEASE_PATH/programs"
verbose_exec "cp -r $CLONE_PATH/programs/hc_chat $RELEASE_PATH/programs/."
verbose_exec "cp -r $CLONE_PATH/programs/hc_status $RELEASE_PATH/programs/."
verbose_exec "cp -r $CLONE_PATH/programs/img $RELEASE_PATH/programs/."
verbose_exec "cp -r $CLONE_PATH/programs/monitoring $RELEASE_PATH/programs/."
verbose_exec "cp -r $CLONE_PATH/programs/pktgen $RELEASE_PATH/programs/."
verbose_exec "rm -rf $RELEASE_PATH/programs/monitoring/daemon_ios"
