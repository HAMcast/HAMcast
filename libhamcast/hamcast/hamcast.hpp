 ...
 *
 * HAMcast uses @c cmake on Unix platforms (Linux, Mac OS X, etc.), we 
 * recommend an out-of-source build. The usual way to build libhamcast is:
 *
 * <code>
 * mkdir build<br>
 * cd build<br>
